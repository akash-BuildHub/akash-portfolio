...
const projects: Project[] = [
  ...
  },
  {
    title: 'Vision Snap',
    description:
      'Vision Snap is a web-based tool for creating image datasets for computer vision. It captures images from live webcams and extracts frames from uploaded videos. Users can organize samples into custom classes and export them as ML-ready datasets.',
  ...
  },
  {
    ...
    description:
      'An advanced AI-based system focused on recognition and detection tasks using computer vision and deep learning techniques, enabling accurate identification, classification, and analysis of visual data.',
    features: ['Object Detection', 'Recognition', 'Deep Learning'],
    icon: Hospital,
  },
];
