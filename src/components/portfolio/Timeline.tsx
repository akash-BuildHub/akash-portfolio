...
const timelineData: TimelineItem[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'AI/Research – Computer vission, Network optimization, Deep Learning, Machine Learning, AI - Recognition | Detection | Classification',
    ],
  },
];
...
const Timeline = () => {
  ...
  return (
    <section
      id="timeline"
      ref={sectionRef}
      className="py-24 md:py-32 relative hidden"
    >
